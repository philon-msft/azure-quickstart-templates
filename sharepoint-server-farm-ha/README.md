# Create a High Availability SharePoint Farm with 9 VMs using the PowerShell DSC Extension
...
|vmSettings.adPDCVMName|The name of the Primary Domain Controller|
|vmSettings.adBDCVMName|The name of the Backup\Second Domain Controller|
|vmSettings.sqlVMName|The prefix for the SQL VM Names|
|vmSettings.sqlwVMName|The name of the File Share Witness|
|vmSettings.spwebVMName|The Prefix of the SharePoint Web Server VMs|
|vmSettings.spappVMName|The Prefix of the SharePoint App Server VMs|
|windowsImagePublisher|The name of the publisher of the AD and Witness Image|
